...
import ProductCard from "../components/ProductCard"; // Statik ürün için bir kart bileşeni
import { ChevronRight, SlidersHorizontal } from "lucide-react";
import React from "react";

function Category(){
    const location = useLocation();
  const path = location.pathname.split("/")[2]; // /category/men veya /category/women

  const category = path.charAt(0).toUpperCase() + path.slice(1); // 'Men' ya da 'Women'
